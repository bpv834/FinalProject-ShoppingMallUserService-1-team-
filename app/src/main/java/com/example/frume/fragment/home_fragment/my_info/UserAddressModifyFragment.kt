 ...
 * Use the [UserAddressModifyFragment.newInstance] factory method to
...
class UserAddressModifyFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment UserAddressModifyFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            UserAddressModifyFragment().apply {
