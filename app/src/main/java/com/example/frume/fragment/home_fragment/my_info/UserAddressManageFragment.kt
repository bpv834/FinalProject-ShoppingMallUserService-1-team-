 ...
 * Use the [UserAddressManageFragment.newInstance] factory method to
...
class UserAddressManageFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment UserAddressManageFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            UserAddressManageFragment().apply {
